...
* 微盟 - 上海向心云网络科技有限公司（SaaS电商）（线上门店，选品之后，商品是门店商品，库存是门店库存）
  - 草动商城后台管理系统：Vue-CLI + Vue全家桶 + Element-UI
    ...
    - 值得一说的事：封装业务组件、引入单元测试（Jest）、引入commit提交规范、引入GitLab的CI/CD自动化打包、引入企微机器人接口报警、促进后端接口规范、引入微前端、引入Vue3全家桶和TS/TSX以及Element-Plus。获得了2019年的年度优秀员工。
...
* 商派 - 上海商派网络科技有限公司（SaaS电商）（线上商城，无需选品，商品是商城商品，库存是商城库存）
  - 云起微商城后台管理系统：Gulp + SeaJS + jQuery + Vue
    ...
    - 值得一说的事：封装基础组件和业务组件、进行前端工程化、引入Gulp/Webpack、引入模块化、引入ES6、引入Scss、引入iconfont、引入代码压缩以及gzip概念、引入非覆盖式发布以及CDN概念。获得了2016年二季度的优秀员工。
...
* 头脑还算的上灵活，学习还算的上勤奋。
* 为人随和，多年来和同事相处都挺融洽。
* 我定位问题的能力好像还是挺强的，不管是客户端问题，还是服务端问题我都能推理的八九不离十。
* 我负责过的项目好像都还挺稳定的，没有那么多的问题，近几年很少遇到上线后还出现问题的场景。
