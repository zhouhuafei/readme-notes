...
* innisfree项目，h5文章中小程序的链接替换为二维码 - 主分支中也需要加。
    ...
    - 分享商品卡片，进入中转页，然后从中转页再进入其他小程序。待续...
    - 小程序跳小程序。appid不正确。待续...
    - 优惠券h5对接。待续...
    - 活动详情页换标题图。待续...
    - 商品中心。筛选样式优化。待续...
...
* 优惠券说明使用rich-text。待续...
* .g-task-tag换颜色。待续...
* 半年后删除的文案补充。不能删。因为有场景在使用。除非存储的二维码加s=。待续...
* 我的优惠券列表点击跳优惠券详情页。
* 优惠券详情增加优惠券码字段。
...
* E:\www\gitlab-juzhi\xcx-caodong-user\src\pages\gallery\gallery.json 
    - "navigationBarTextStyle": "black" 待续...
