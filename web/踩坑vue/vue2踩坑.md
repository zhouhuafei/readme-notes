...
* el-table最后一列错位：我给最后一列加了`fixed="right"`属性。
...
# node-sass安装不上
* 解决方案1：`npm i node-sass --sass_binary_site=https://npm.taobao.org/mirrors/node-sass/`
* 解决方案2: `npm i sass@1.22.0`。并把`/deep/`改为`::v-deep`。
