...
* 在线网站（国产/尚未收费）：https://rightbrain.art/text2Image
  ...
  - 案例（风格选手绘头像/模型选虚拟建模）：一个微笑着的可爱短发女孩，汉服，白色背景。
  - 案例（风格选手绘头像/模型选虚拟建模）：一个微笑着的可爱短发女孩，机甲，白色背景。
  - 案例（风格选手绘头像/模型选虚拟建模）：一个长发女孩，穿着绿色连衣裙，戴着绿色领结，白色背景。
  - 案例（风格选手绘头像/模型选虚拟建模）：一个长发女孩，穿着红色连衣裙，戴着红色领结，白色背景。
