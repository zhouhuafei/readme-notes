...
<body style="font-size: 40px;line-height: 1;text-align: center;margin: 40px;width: 200px;color: #ffffff;">
  <div style="background: green;"><span style="font-size: 12px;">你好</span></div>
  <!--
  上述div
  Chrome 134及之前 div的高度是12px
  Chrome 135及之后 div的高度是40px 且span居底对齐
  -->
  <div style="background: blue;"><p style="font-size: 12px;margin: 0;">你好</p></div>
  <!--
  上述div
  Chrome 134及之前 div的高度是12px
  Chrome 135及之后 div的高度是12px
  -->
</body>
<!--
Chrome 135及之后 内联元素的渲染机制发生了变化
