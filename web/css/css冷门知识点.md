...
## 100vh
> 我手机是小米14
* h5端，在小米浏览器上，上中下flex布局，中间flex为1且纵向超出允许滚动。
* 最外层设置100vh时，下层区域会被菜单栏遮挡。我手机上中间层高度为660px。可视区高为735px。
  - 最外层设置100%时，出现异常，flex为1的中间区域高度异常。在我手机上多出了25px。其他区域高度包括可视区高度均正常。
* 最外层设置100%时，下层区域不会被菜单栏遮挡。我手机上中间层高度为635px。可视区高为735px。
  - 最外层设置100%时，一切正常，flex为1的中间区域高度正常。
