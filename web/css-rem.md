...
* 因chrome浏览器限制页面的最小字体是12px。
    ...
    - mac的2倍屏上，chrome浏览器，字体最小可以设置为0px。(此时浏览器的高级设置里，默认最小设置为6px)。由此可得。和屏幕的设备物理像素比是有关的。
    - win的1.75倍屏上，chrome浏览器，字体最小可以是6px。(此时浏览器的高级设置里，默认最小设置为6px)。由此可得。和屏幕的设备物理像素比是有关的。
