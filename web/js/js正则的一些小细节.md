...
* 金钱格式化：https://www.jianshu.com/p/56d589ea48a9
  - 使用正则：`'100000000.0011111'.replace(/(?<!\.\d*)(\d)(?=(\d{3})+($|\.))/g, '$1,') // '100,000,000.0011111'`。
  - 使用正则：`'100000000.0011111'.replace(/(?<=\.\d*)(\d)(?=(\d{3})+($|\.))/g, '$1,') // '100000000.0,011,111'`。
  - 使用正则：`'100000000.0011111'.replace(/(\d)(?=(\d{3})+($|\.))/g, '$1,') // '100,000,000.0,011,111'`。
* 6至16位字符且包含数字和字母
  ```
  var str = '0000000000a';
