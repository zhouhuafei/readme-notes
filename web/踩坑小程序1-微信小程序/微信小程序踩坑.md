...
* 如果是tabBar页面。screenHeight是完整的屏幕高度。windowHeight是screenHeight减去tabBar高度再减去底部安全区域高度后的高度。
  - 只要是tabBar页面，即使tabBar被隐藏，上述依然成立。
* 如果非tabBar页面。screenHeight是完整的屏幕高度。windowHeight高度和screenHeight高度相等。
...
> 关键词：rpx转px、rpx自动转px、rpx会被自动转换为px
#### 小米-14：windowWidth是400，windowHeight是874，pixelRatio是3。
#### 问题1-0：给标签设置left:0rpx，在我的小米14手机上，会被转换为1px。此时，全屏的开屏页，会出现白边。注意：给标签设置left:0时不会出现问题，只要单位是rpx就会存在问题。
#### 问题2-0：给标签设置left:0rpx，在我的小米14手机上，会被转换为1px。400/750*0.2等于0，即等于0时，会转换为1。
#### 问题2-1：给标签设置left:0.2rpx，在我的小米14手机上，会被转换为1px。400/750*0.2等于0.106，即大于0且小于1时，会向上取整。
#### 问题2-2：给标签设置left:0.8rpx，在我的小米14手机上，会被转换为1px。400/750*0.8等于0.426，即大于0且小于1时，会向上取整。
#### 问题2-3：给标签设置left:2.8rpx，在我的小米14手机上，会被转换为1px。400/750*2.8等于1.493，即大于1时，会向下取整。
#### 问题2-4：给标签设置left:3.2rpx，在我的小米14手机上，会被转换为1px。400/750*3.2等于1.706，即大于1时，会向下取整。
#### 问题2-5：给标签设置left:3.8rpx，在我的小米14手机上，会被转换为2px。400/750*3.8等于2.026，即大于1时，会向下取整。
#### 问题2-6：给标签设置left:-0.2rpx，在我的小米14手机上，会被转换为-1px。400/750*-0.2等于-0.106，即大于-1且小于0时，会向下取整。
#### 问题2-7：给标签设置left:-0.8rpx，在我的小米14手机上，会被转换为-1px。400/750*-0.8等于-0.426，即大于-1且小于0时，会向下取整。
#### 问题2-8：给标签设置left:-2.8rpx，在我的小米14手机上，会被转换为-1px。400/750*-2.8等于-1.493，即小于-1时，会向上取整。
#### 问题2-9：给标签设置left:-3.2rpx，在我的小米14手机上，会被转换为-1px。400/750*-3.2等于-1.706，即小于-1时，会向上取整。
#### 问题2-10：给标签设置left:-3.8rpx，在我的小米14手机上，会被转换为-2px。400/750*-3.8等于-2.026，即小于-1时，会向上取整。
#### 解决方案之wxss：wxss设置时，如果是0，就不要附加rpx单位。如果不是0，则这些误差是可以接受的。
#### 解决方案之wxml：wxml设置时，自行把rpx转换为px，使用windowWidth/750*目标值进行计算。
