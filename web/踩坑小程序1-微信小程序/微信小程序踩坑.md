...
* web-view组件长按识别支持哪些二维码？
  ...
  - web-view组件内嵌普通H5页面支持识别：微信个人码、企微个人码、微信群码、企微群码、小程序码（在自己的小程序中用web-view内嵌h5去识别自己的小程序码自然也是可以的）。
  - web-view组件内嵌公众号文章支持识别：微信个人码、企微个人码、微信群码、企微群码、小程序码（在自己的小程序中用web-view内嵌h5去识别自己的小程序码自然也是可以的）、公众号二维码。
...
* URL Link：适用于短信、邮件、外部网页、微信内等拉起小程序的业务场景。有效期最长30天。单日生成上限为50万。无总上限。
...
* 文档：https://developers.weixin.qq.com/miniprogram/dev/wxcloud/guide/staticstorage/msg-miniprogram.html
