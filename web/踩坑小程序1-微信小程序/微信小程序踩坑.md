...
* 微信内网页跳转APP功能（主动）：https://developers.weixin.qq.com/doc/oplatform/Mobile_App/WeChat_H5_Launch_APP.html

# h5跳小程序
* 微信内h5跳小程序（开放标签）：https://developers.weixin.qq.com/doc/offiaccount/OA_Web_Apps/Wechat_Open_Tag.html#%E5%BC%80%E6%94%BE%E6%A0%87%E7%AD%BE%E8%AF%B4%E6%98%8E%E6%96%87%E6%A1%A3
* 微信外h5跳小程序（URL Scheme）：https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/url-scheme.html
  - 补充：亲测后发现，微信内h5跳小程序，使用URL Scheme如今也已经行得通了，Android和IOS均可以正常使用。
...
* URL Scheme：适用于短信、邮件、外部浏览器、微信内置浏览器、微信内等拉起小程序的业务场景。有效期最长30天。单日生成上限为50万。无总上限。
  - 亲测在不同的场景中使用：具体如下↓
  ...
  - 访问限制：从外部浏览器中访问时只能被1个用户访问。在微信内置浏览器中访问时不存在只能被1个用户访问的限制。
    - 在微信内点击URL Scheme时，会先打开微信内置浏览器，再出现弹窗询问。
