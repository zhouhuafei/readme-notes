...
* 1倍屏320px的图片，3px的css像素，等于1像素的设备独立像素，1像素的设备独立像素等于1像素的设备物理像素，等比缩小，图片不会模糊。
* 2倍屏320px的图片，960图片的设备物理像素，变成了640的设备物理像素，等比缩小，图片不会模糊。待续...
* 3倍屏320px的图片，960图片的设备物理像素，变成了960的设备物理像素，没有缩放，图片不会模糊。待续...
* 所以手机端一般是使用2倍图或者3倍图。
