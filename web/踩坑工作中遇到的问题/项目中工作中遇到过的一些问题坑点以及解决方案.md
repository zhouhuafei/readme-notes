...
## 公告图中的文字在大屏上无法清晰展示？
* 我家里的显示屏分辨率是：`3840*2160`。dpr无法测量。`27`英寸。`4K`屏幕。
  - `window.devicePixelRatio`无法获取外接显示屏的dpr。因为我用MAC外接时是`2`，用ThinkPad外接时是`1.5`。获取的都是设备主屏幕的dpr。...TODO 也许可以把外接显示屏设置为主屏幕再获取一次？
* 我家里MAC电脑分辨率是：`2560*1600`。dpr是`2`。外接了我家里的显示屏。按照4500尺寸的psd切图，公告图在小屏上超级清晰，在大屏上也超级清晰。
* 我家里ThinkPad电脑分辨率是：`1920*1080`。dpr是`1.5`。外接了我家里的显示屏。按照4500尺寸的psd切图，公告图在小屏一般清晰，在大屏上也一般清晰。
* 我公司DELL电脑分辨率是：`2560*1440`。dpr是`1`。未外接大屏。按照4500尺寸的psd切图，公告图在屏幕上显示时，比ThinkPad小屏清晰，没MAC小屏清晰。
